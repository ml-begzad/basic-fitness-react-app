...
const Index = ({isTopOfPage, selectedPage, setSelectedPage}:Props) => {
    ...
    const navBachground=(isTopOfPage) ? "":"bg-red-100 drop-shadow"
  return (
    <nav>
        <div className={`${navBachground} ${flexBetween} fixed top-0 z-30 w-full py-6`} >
        ...
        {/* Mobile Menu Icon */}
        {!isAboveMediumScreens && isMenuToggled && (<div className='fixed right-0 bottom-0 z-40 h-full w-[250px] bg-red-100 drop-shadow-xl' onClick={() => setIsMenuToggled(!isMenuToggled)}>
            {/* Close Icon */}
